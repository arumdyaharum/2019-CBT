...
if($type != 'xlsx') {
    echo "<script>window.location='../daftar_siswa/tambah/import?error=type';</script>";
} else {
...
foreach ($sheetData as $t) {
    ...
    mysqli_query($conn, "INSERT INTO tb_siswa VALUES ('', '$t[1]', '$t[2]', '$kelas[id_kelas]', '$date', '$t[5]', '$t[6]', sha2('$t[7]',0), '$t[7]', 'nonaktif')");
}
echo "<script>window.location='../daftar_siswa';</script>";
}